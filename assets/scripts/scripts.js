...
typewriter.typeString('Hello There!')
    ...
    .deleteAll()
    .pauseFor(500)
    .typeString("I specialize in Machine Learning and Prototyping.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("I finished my BS in CS at GT in May 2024.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
    .typeString("! expect to finish my MS in August 2025.")
    .pauseFor(1000)
    .deleteAll()
    .pauseFor(500)
